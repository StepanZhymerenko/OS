...
// Обробник очищення для потоку-нащадка
void cleanup_handler(void *arg) {
    int *iteration = (int *)arg;
    fprintf(stderr, "Потік завершено на ітерації %d\n", *iteration);
}
...
void* print_thread(void *arg) {
    ...
    // Встановлюємо обробник очищення
    ...
    // Знімаємо обробник очищення без виконання, оскільки цикл нескінченний
